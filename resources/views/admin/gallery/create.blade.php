        ...
        <div class="row">
            <div class="page-title">
                <div class="title_left">
                    <h3>{{trans('admin.add_img')}}</h3>
                </div>

                <div class="title_right">
                    <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                        <a class="btn btn-primary" style="color: #fff" href="{{ url("/admin/gallery") }}"> {{trans('admin.see_all_img')}}</a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form data-parsley-validate action="{{action('GalleryController@store')}}" class="form-horizontal form-label-left" method="post" enctype="multipart/form-data">
                              {{ csrf_field() }}
                                    ...
                                    <div id="myTabContent" class="tab-content">
                                        ...
                                        @foreach ($locale as $key => $local)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <input type="file" name="img[]" multiple id="img" required class="form-control col-md-7 col-xs-12">
                                                </div>
                                            </div>
                                    </div>
                                </div>
